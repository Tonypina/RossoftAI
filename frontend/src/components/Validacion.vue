<template>
    <div class="pt-5">
        ...
        <div class="pt-5">
            ...
            <div class="w-full">
                <img class="w-full" :src="this.tree" alt="">
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        props: ['dataName', 'score', 'intercept', 'coef', 'tempdict', 'matrix'],
            ...
            for (let i = 0; i < this.matrix.length; i++) {
                for (let j = 0; j < headersList.length; j++) {
                    ...
                    this.tempdict ?
                        ...
                        this.chartData.datasets[0].data[this.chartData.datasets[0].data.length] = this.matrix[i][
                            headersList[j]
                        ]
                }
            }
